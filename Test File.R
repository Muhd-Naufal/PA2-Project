...
data <- fromJSON("https://developers.onemap.sg/privateapi/commonsvc/revgeocode?location=1.3812858,103.7449823&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..0WQUOPl_s0n9TxNaLondpmVamvAvt0PLFSYzCQlkhpU&buffer=500&addressType=ALL&otherFeatures=Y")
data
