...
The graph above depics how the increasing POI affects resale value of HDB flats. We can see that as POI gradually increases, the resale prices increases too. Although the line is 'curvy' as in it increases and decreases over time, but overall, we can see that resale prices do increase as POI increase. This can be further proven through the regression line which also shows an overall general increase. Thus, we can conclude that POI does affect resale value.
